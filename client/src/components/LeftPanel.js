...
import { getUserListFromCurrentUser } from "../services/firebase";

function LeftPanel() {
  useEffect(() => {
    getUserListFromCurrentUser();
  }, []);

  return (
    <div className="left-panel panel">
      <div className="flex justify-between mr-[5px] ml-[20px] my-[10px]">
        ...
        <div className="options">
          ...
          />
          {/* <WhatsappIcons type="status" style={`mx-2 mt-2 text-[#54656F]`} /> */}
